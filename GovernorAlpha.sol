...
contract GovernorAlpha is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("GovernorAlpha")
        GovernorSettings(1 days /* Voting Delay */, 1 week /* Voting Period */, 0)
